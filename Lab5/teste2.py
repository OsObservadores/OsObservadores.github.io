...
output_dir = "/home/ufabc/Documentos/cv2025/Lab5"
os.makedirs(output_dir, exist_ok=True)
output_path = os.path.join(output_dir, "saida_match.avi")

# Inicializa o VideoWriter (vai ser criado após pegar o primeiro frame)
video_writer = None
...
try:
    while True:
        ...
        # Inicializa o writer após o primeiro frame
        ...
        if key == ord('x'):  # encerra e salva o vídeo
